...
0xDE, 0x00,
0xDF, 0x80,
0xF6, 0x00, // it is matter for clockout
0xF7, 0x16,
0xF8, 0x01,// it is matter for clockout
0xF9, 0xE3,// it is matter for clockout
0xFA, 0x8F,// it is matter for clockout
0xFB, 0x40,
0xFC, 0x30,
0xFD, 0x75,//0x11,// it is matter for clockout

0xFF, 0x01, // Page 01
0x01, 0x68,
0x02, 0x40,		// for intput Y2
0x04, 0x00,
0x05, 0x09,
0x06, 0x00,
0x07, 0x02,
