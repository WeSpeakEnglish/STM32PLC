...
GUI_SetObject(LINE_TYPE, 0xFFFF0000, 1, 4, 100,100,1200,1200);
GUI_SetObject(LINE_TYPE, 0x33FF0000, 1, 4, 100,100,500,800);
GUI_SetObject(CIRCLE_TYPE, 0xFFFFFF00, 1, 3, 300, 300, iLoad);
GUI_SetObject(CIRCLE_TYPE, 0xFFFF00FF, 1, 3, 200+iLoad, 200, iLoad);
GUI_SetObject(CIRCLE_TYPE, 0xFF00FF00, 1, 3, 300-iLoad, 300, iLoad);
}
